  ...
  <div class="l-footer_container l-inner">
    <div class="l-footer__top">
      <figure class="l-footer__logo-wrapper">
        <a class="l-footer__logo-link" href="<?php echo esc_url( home_url( '/' ) ); ?>">
          <img class="l-footer__logo-image"
            src="<?php echo get_theme_file_uri( '/assets/images/common/footer-logo.png' ); ?>" alt="アドネス株式会社ロゴ" />
        </a>
      </figure>
    ...
    <div class="l-footer__bottom">
      ...
      <div class="l-footer__contact-wrapper">
        <a class="l-footer__contact-item" href="https://addness.co.jp/wp-content/uploads/2022/04/アドネス会社案内資料.pdf"
